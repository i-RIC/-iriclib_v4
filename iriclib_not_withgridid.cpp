...
int cg_iRIC_Read_Grid_Complex_IFace(int fid, const char* groupname, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_Complex_IFace_WithGridId(fid, gid, groupname, v_arr);
}

int cg_iRIC_Read_Grid_Complex_JFace(int fid, const char* groupname, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_Complex_JFace_WithGridId(fid, gid, groupname, v_arr);
}
...
int cg_iRIC_Write_Grid_Complex_IFace(int fid, const char* groupname, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Write_Grid_Complex_IFace_WithGridId(fid, gid, groupname, v_arr);
}

int cg_iRIC_Write_Grid_Complex_JFace(int fid, const char* groupname, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Write_Grid_Complex_JFace_WithGridId(fid, gid, groupname, v_arr);
}
...
int cg_iRIC_Read_Grid_CellType(int fid, int* type)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_CellType_WithGridId(fid, gid, type);
}
...
int cg_iRIC_Read_Grid_LineElementsSize(int fid, int* tsize)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_LineElementsSize_WithGridId(fid, gid, tsize);
}

int cg_iRIC_Read_Grid_LineElementsSize2(int fid, int* tsize)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_LineElementsSize2_WithGridId(fid, gid, tsize);
}

int cg_iRIC_Read_Grid_LineElements(int fid, int* id_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;

  return cg_iRIC_Read_Grid_LineElements_WithGridId(fid, gid, id_arr);
}
...
int cg_iRIC_Read_Grid_Real_IFace(int fid, const char* name, double* v_arr)
{
  ...
  return cg_iRIC_Read_Grid_Real_IFace_WithGridId(fid, gid, name, v_arr);
}

int cg_iRIC_Read_Grid_Integer_IFace(int fid, const char* name, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Grid_Real_JFace(int fid, const char* name, double* v_arr)
{
  ...
  return cg_iRIC_Read_Grid_Real_JFace_WithGridId(fid, gid, name, v_arr);
}

int cg_iRIC_Read_Grid_Integer_JFace(int fid, const char* name, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Grid_Functional_Integer_IFace(int fid, const char* name, int dimid, int* v_arr)
{
  ...
  return cg_iRIC_Read_Grid_Functional_Integer_IFace_WithGridId(fid, gid, name, dimid, v_arr);
}

int cg_iRIC_Read_Grid_Functional_Real_IFace(int fid, const char* name, int dimid, double* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Read_Grid_Functional_Integer_JFace(int fid, const char* name, int dimid, int* v_arr)
{
  ...
  return cg_iRIC_Read_Grid_Functional_Integer_JFace_WithGridId(fid, gid, name, dimid, v_arr);
}

int cg_iRIC_Read_Grid_Functional_Real_JFace(int fid, const char* name, int dimid, double* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Grid_Real_IFace(int fid, const char* name, double* v_arr)
{
  ...
  return cg_iRIC_Write_Grid_Real_IFace_WithGridId(fid, gid, name, v_arr);
}

int cg_iRIC_Write_Grid_Integer_IFace(int fid, const char* name, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
...
int cg_iRIC_Write_Grid_Real_JFace(int fid, const char* name, double* v_arr)
{
  ...
  return cg_iRIC_Write_Grid_Real_JFace_WithGridId(fid, gid, name, v_arr);
}

int cg_iRIC_Write_Grid_Integer_JFace(int fid, const char* name, int* v_arr)
{
  int gid;
  int ier = getlastGridId(fid, &gid);
  RETURN_IF_ERR;
